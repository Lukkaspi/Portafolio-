...
import MethodologyPipeline from '../components/MethodologyPipeline.jsx';
...
export default function Project() {
  ...
  return (
    <main className="container-page pb-24 pt-24">
      ...
      {!project.gallery && !project.categories && !project.editions && !project.drawings && !project.methodologies && (
      ...
      {project.methodologies && project.methodologies.length > 0 && (
        <div className="mt-16 md:mt-20">
          <MethodologyPipeline items={project.methodologies} accent={accent} />
        </div>
      )}
